...
<Tip>
  Activa tu plan en [app.cucu.bo](https://app.cucu.bo/signup) para obtener tu API Key. Pasale la key a Claude, Cursor o VS Code via [MCP](/mcp/introduction) y empieza a facturar con lenguaje natural.
