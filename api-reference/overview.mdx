...
<Tip>
  Activa tu plan en [app.cucu.bo](https://app.cucu.bo/signup) para obtener tu API Key. Pasale la key a Claude, Cursor o VS Code via [MCP](/mcp/setup) y empieza a facturar con lenguaje natural.
...
<Card title="Documentacion MCP" icon="microchip" href="/mcp/setup">
