...
<Info>
  El MCP Server expone **14 herramientas** que cubren todo el ciclo de facturacion, incluyendo notas de credito/debito.
...
<CardGroup cols={2}>
  ...
  <Card title="MCP Server" icon="plug" href="/mcp/introduction">
    Conecta tu IA directamente a facturacion electronica con 14 herramientas disponibles.
  </Card>
