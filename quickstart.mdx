...
<Info>
  ...
  Consulta la [documentacion MCP completa](/mcp/setup) para ver todas las herramientas disponibles.
</Info>
...
<div className="gradient-card" style={{marginTop: '32px', textAlign: 'center', padding: '24px'}}>
  **Sandbox incluido en tu plan.** Desarrolla y valida tu integracion completa contra el SIAT Piloto.
  Cuando estes listo, pasa a produccion. O conecta tu AI via [MCP Server](/mcp/setup) — es la forma mas rapida.
</div>
