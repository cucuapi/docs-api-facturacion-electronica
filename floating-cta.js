...
#cucu-mob{position:fixed;bottom:20px;right:16px;z-index:10000;display:none;\
background:linear-gradient(135deg,#6366f1 0%,#8b5cf6 50%,#a855f7 100%);\
color:#fff;padding:14px 20px;font-size:13px;font-weight:700;cursor:pointer;\
font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;\
box-shadow:0 8px 32px rgba(99,102,241,.45),0 0 0 1px rgba(99,102,241,.15);\
border-radius:50px;letter-spacing:.2px;border:1px solid rgba(255,255,255,.18);\
animation:cucuOrbit 3s ease-in-out infinite;align-items:center;gap:8px;\
-webkit-tap-highlight-color:transparent}\
#cucu-mob:active{transform:scale(.93)}\
#cucu-mob svg{width:20px;height:20px}\
#cucu-mob .mob-badge{width:18px;height:18px;border-radius:50%;\
background:linear-gradient(135deg,#10b981,#059669);font-size:9px;font-weight:800;\
display:inline-flex;align-items:center;justify-content:center;\
border:2px solid rgba(99,102,241,.8);box-shadow:0 2px 6px rgba(16,185,129,.4);margin-left:2px}\
...
background:rgba(10,15,30,.97);backdrop-filter:blur(32px) saturate(180%);-webkit-backdrop-filter:blur(32px) saturate(180%);\
border-radius:28px 28px 0 0;padding:20px 20px calc(env(safe-area-inset-bottom,20px) + 20px);\
border-top:1px solid rgba(99,102,241,.3);\
box-shadow:0 -16px 60px rgba(0,0,0,.4),0 0 0 1px rgba(99,102,241,.1),0 0 40px rgba(99,102,241,.06);\
font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif}\
...
border-radius:16px;text-decoration:none;color:inherit;transition:all .15s ease;\
background:rgba(30,41,59,.5);border:1px solid rgba(51,65,85,.5);-webkit-tap-highlight-color:transparent}\
#cucu-sheet .mplan:active{transform:scale(.97);background:rgba(30,41,59,.7)}\
#cucu-sheet .mplan.pop{border-color:rgba(99,102,241,.45);background:linear-gradient(135deg,rgba(99,102,241,.12),rgba(139,92,246,.08));\
position:relative;overflow:hidden}\
#cucu-sheet .mplan.pop .gbar{position:absolute;top:0;left:0;right:0;height:2px;\
background:linear-gradient(90deg,#6366f1,#8b5cf6,#06b6d4,#8b5cf6);background-size:200% 100%;animation:shimmer 3s linear infinite}\
...
#cucu-sheet .mftr{text-align:center;padding:20px 0 0}\
#cucu-sheet .mftr a{display:flex;align-items:center;justify-content:center;gap:8px;font-size:16px;font-weight:700;\
padding:14px 28px;border-radius:14px;text-decoration:none;color:#fff;width:100%;\
background:linear-gradient(135deg,#6366f1,#8b5cf6);box-shadow:0 8px 24px rgba(99,102,241,.35);\
-webkit-tap-highlight-color:transparent;transition:all .15s}\
#cucu-sheet .mftr a:active{transform:scale(.97);box-shadow:0 4px 16px rgba(99,102,241,.2)}\
#cucu-sheet .mftr .sub{font-size:11px;color:#475569;margin-top:10px}\
';
  ...
  function mobileSheet() {
    ...
    PLANS.forEach(function (p) {
      ...
      a.innerHTML = (p.popular ? '<div class="gbar"></div>' : '') +
        '<div><div style="display:flex;align-items:center"><span class="mname">' + p.name + '</span>' +
  ...
  function resize() {
    if (mobile()) {
      ...
      if (mob) mob.style.display = 'inline-flex';
    } else {
