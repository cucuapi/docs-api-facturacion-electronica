...
<CardGroup cols={2}>
  ...
  <Card title="obtenerFacturaPorCuf" icon="qrcode">
    Obtiene una factura por su CUF (Codigo Unico de Factura),
    el identificador unico ante el SIN.
  </Card>
  <Card title="verificarEstadoFactura" icon="circle-check">
...
<CardGroup cols={2}>
  ...
  <Card title="Referencia de herramientas" icon="wrench" href="/mcp/tools">
    Documentacion detallada de las 14 herramientas: parametros,
