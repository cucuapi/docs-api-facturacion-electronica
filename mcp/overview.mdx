...
description: "Conecta Claude, Cursor o cualquier AI directamente a facturacion electronica boliviana. 15 herramientas MCP, lenguaje natural, zero codigo."
---
...
<div style={{textAlign: 'center', marginBottom: '32px'}}>
  ...
  <p style={{fontSize: '1.15rem', color: '#94a3b8', maxWidth: '600px', margin: '0 auto', lineHeight: '1.6'}}>
    15 herramientas MCP. Lenguaje natural. Facturacion electronica completa
