...
Con el MCP Server de CUCU, tu asistente AI tiene acceso a **14 herramientas** que cubren todo el ciclo de facturacion: emision, anulacion, notas de credito/debito, consulta, verificacion de NIT y mas. Es la forma mas rapida y natural de integrar facturacion electronica en tu flujo de trabajo.
