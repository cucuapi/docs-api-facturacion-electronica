...
|-------|------|-----|-------------|
| `invoiceType` | string | Si | Tipo de factura que determina el documento sector y modalidad. Default: `ELECTRONIC_SALE`. Ver [Documentos Sector](/api/overview#tipos-de-documento-sector) para todos los valores. |
